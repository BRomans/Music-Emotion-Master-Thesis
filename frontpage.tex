...
\node[anchor=north west,inner sep=0pt] at (0,0) {\includegraphics[height=297mm]{frontpage/sidebar_em}};
% Include big logo
...
\node[inner sep=0pt] at (13,-13.5) {
\begin{minipage}{20cm}
\begin{center}
\fontsize{20}{25}\selectfont
\textbf{Music-Emotion: \\Towards automated real-time \\recognition of affective states with\\ a wearable Brain-Computer Interface}
\end{center}
\end{minipage}
};
...
\node[inner sep=0pt] at (13,-18) {
	\begin{minipage}{20cm}
		...
		\textbf{\Large{
		Michele Romani\\[1mm]
		M.Sc. Thesis in Human-Computer Interaction \& Design\\[1mm]
		February 2022
		}}
		\end{center}
	\end{minipage}
